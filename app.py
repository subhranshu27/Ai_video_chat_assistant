...
if st.session_state.result:
    ...
    # ── RAG Chat ──────────────────────────────────────────────────────────────
    st.markdown('<div style="font-family:\'Syne\',sans-serif;font-size:1.2rem;font-weight:700;margin-bottom:1rem;color:#ffffff">💬 Chat with your Meeting</div>', unsafe_allow_html=True)
    ...
    if st.session_state.chat_history:
        ...
        for msg in st.session_state.chat_history:
            if msg["role"] == "user":
                ...
                <div class="chat-msg" style="align-items:flex-end">
                    <span class="chat-label user-label" style="color:#e9d5ff">You</span>
                    <div class="chat-bubble user-bubble" style="color:#ffffff">{msg['content']}</div>
                </div>"""
            else:
                chat_html += f"""
                <div class="chat-msg" style="align-items:flex-start">
                    <span class="chat-label bot-label" style="color:#a5f3fc">🤖 Assistant</span>
                    <div class="chat-bubble bot-bubble" style="color:#ffffff">{msg['content']}</div>
                </div>"""
        chat_html += '</div>'
        ...
        <div class="card" style="text-align:center;padding:2rem">
            ...
            <div style="color:#e5e7eb;font-size:0.85rem">Ask anything about your meeting transcript</div>
        </div>""", unsafe_allow_html=True)
    ...
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:5rem 2rem;text-align:center">
        ...
        <div style="font-family:'Syne',sans-serif;font-size:1.5rem;font-weight:700;color:#ffffff;margin-bottom:0.5rem">
            Ready to Analyse
        </div>
        <div style="color:#e5e7eb;font-size:0.85rem;max-width:380px;line-height:1.7">
